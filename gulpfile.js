...
const compileToES5 = function()
{
	...
	return gulp.src( jsEntrypoints ).
		...
		pipe(gulp.dest("qm9k/assets/dist/ancient-js/"));
};
...
const compileToES2015 = function()
{
	...
	return gulp.src([ "qm9k/assets/src/js/*.js" ]).
		...
		pipe(gulpif(!argv.production, sourcemaps.write("."))).
		pipe(gulp.dest("qm9k/assets/dist/js/"));
};
...
function compileStyle()
{
	const localPostCSS = postcss([
		postCssSvg({ paths: ["qm9k/assets/src/svg"] }),
	...
	return gulp.src([ "qm9k/assets/src/scss/**/*.scss" ]).
		...
		pipe(gulpif(!argv.production, sourcemaps.write())).
		pipe(gulp.dest("qm9k/assets/dist/css/"));
};

const watchStyle = function()
{
	return gulp.watch( [ "qm9k/assets/src/scss/**/*.scss" ], compileStyle );
};
